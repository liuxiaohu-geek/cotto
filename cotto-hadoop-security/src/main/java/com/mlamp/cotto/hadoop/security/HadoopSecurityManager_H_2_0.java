...
import com.mlamp.cotto.core.Constant;
import com.mlamp.cotto.core.Constants;
import com.mlamp.cotto.core.Props;
import com.mlamp.cotto.core.UndefinedPropertyException;
import com.mlamp.cotto.hadoop.security.common.HadoopSecurityManager;
import com.mlamp.cotto.hadoop.security.common.HadoopSecurityManagerException;
...
import static com.mlamp.cotto.core.Constants.ConfigurationKeys.AZKABAN_SERVER_NATIVE_LIB_FOLDER;
import static com.mlamp.cotto.core.Constants.JobProperties.EXTRA_HCAT_CLUSTERS;
import static com.mlamp.cotto.core.Constants.JobProperties.EXTRA_HCAT_LOCATION;
...
public class HadoopSecurityManager_H_2_0 extends HadoopSecurityManager {
    ...
    public UserGroupInformation getProxiedUser(final Props userProp)
            throws HadoopSecurityManagerException {
        final String userToProxy = verifySecureProperty(userProp, Constant.JobProperties.USER_TO_PROXY);
    ...
    public void prefetchToken(final File tokenFile, final Props props, final Logger logger)
            throws HadoopSecurityManagerException {
        final String userToProxy = props.getString(Constant.JobProperties.USER_TO_PROXY);
