...
package com.mlamp.cotto.hadoop.security.common;
...
public class SecurityUtils {
    ...
    public static UserGroupInformation getProxiedUser(final Properties prop,
        ...
        final String toProxy = verifySecureProperty(prop, Constant.JobProperties.USER_TO_PROXY, log);
    ...
    public static synchronized void prefetchToken(final File tokenFile,
        ...
        logger.info("Getting proxy user for " + p.getString(Constant.JobProperties.USER_TO_PROXY));
                ...
                new PrivilegedExceptionAction<Void>() {
                    ...
                    private void getToken(final Props p) throws InterruptedException,
                        ...
                        if (shouldPrefetch != null && shouldPrefetch.equals("true")) {
                            ...
                            final Token<?> fsToken =
                                    fs.getDelegationToken(p.getString(Constant.JobProperties.USER_TO_PROXY));
