...
import static com.mlamp.cotto.core.Constants.ConfigurationKeys.*;
import static com.mlamp.cotto.storage.StorageImplementationType.DATABASE;


public class CottoCommonModuleConfig {

    private static final Logger log = Logger.getLogger(CottoCommonModuleConfig.class);

    private final Props props;
    private final URI hdfsRootUri;
    /**
     * Storage Implementation This can be any of the {@link com.mlamp.cotto.storage.StorageImplementationType} values in which
    ...
    @Inject
    public CottoCommonModuleConfig(final Props props) {
        this.props = props;
