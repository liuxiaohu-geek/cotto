...
public abstract class AbstractMetric<T> implements IMetric<T>, Cloneable {
     ...
     * {@inheritDoc}
     *
     * @see com.mlamp.cotto.metric.IMetric#getName()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see com.mlamp.cotto.metric.IMetric#getValueType()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see com.mlamp.cotto.metric.IMetric#updateMetricManager(com.mlamp.cotto.metric.MetricReportManager)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see com.mlamp.cotto.metric.IMetric#getSnapshot()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see com.mlamp.cotto.metric.IMetric#getValue()
     */
    @Override
    public T getValue() {
        return this.value;
     ...
     *
     * @see com.mlamp.cotto.metric.IMetric#notifyManager()
     */
    @Override
