...
package com.mlamp.cotto.metric.inmemoryemitter;

import com.mlamp.cotto.core.Props;
import com.mlamp.cotto.metric.IMetric;
import com.mlamp.cotto.metric.IMetricEmitter;
import com.mlamp.cotto.metric.MetricException;
...
public class InMemoryMetricEmitter implements IMetricEmitter {
     ...
     *
     * @see com.mlamp.cotto.metric.IMetricEmitter#reportMetric(com.mlamp.cotto.metric.IMetric)
     */
    @Override
     ...
     *
     * @see com.mlamp.cotto.metric.IMetricEmitter#purgeAllData()
     */
    @Override
