...
import com.mlamp.cotto.spi.CottoException;
...
import static com.mlamp.cotto.core.Constants.ConfigurationKeys.AZKABAN_KERBEROS_PRINCIPAL;
import static com.mlamp.cotto.core.Constants.ConfigurationKeys.AZKABAN_KEYTAB_PATH;
    ...
    public void authorize() {
        if (this.isSecurityEnabled) {
            try {
                ...
                log.error(e);
                throw new CottoException(String.format(
