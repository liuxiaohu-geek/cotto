...
public class DatabaseOperator {
    ...
    /**
     * Note: this queryRunner should include a concrete {@link CottoDataSource} inside.
     */
    @Inject
     ...
     * {@link CottoDataSource#getConnection()} inside queryrunner.query.
     *
     ...
     */
    public CottoDataSource getDataSource() {
        return (CottoDataSource) this.queryRunner.getDataSource();
    }

    /**
     * Executes the given AZ related INSERT, UPDATE, or DELETE SQL statement.
     * it will call {@link CottoDataSource#getConnection()} inside
     * queryrunner.update.
     *
